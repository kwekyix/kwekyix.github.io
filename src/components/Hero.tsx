...
export function Hero() {
  return (
    <section className="relative flex min-h-screen items-center pt-[130px] pb-[130px] max-tabsm:min-h-0 max-tabsm:pt-[100px] max-tabsm:pb-[80px] max-phone:pt-[80px] max-phone:pb-[60px]">
      <Container>
        <div className="mb-[30px] inline-flex items-center gap-2 rounded-sm border border-border bg-accent-tint px-[18px] py-2 text-[16px] text-accent uppercase max-phone:mb-4">
          Available for internships &amp; opportunities
        </div>
        <h1 className="mb-[26px] w-full font-minecraft text-[68px] leading-[1.08] font-normal max-tablet:text-[clamp(48px,6vw,56px)]">
        ...
        <p className="mb-11 max-w-[80%] text-[16px] leading-[1.7] text-accent">
